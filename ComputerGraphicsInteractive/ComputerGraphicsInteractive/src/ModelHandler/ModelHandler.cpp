...
namespace Engine
{
	namespace ModelHandling
	{
		...
		void ModelHandler::CalculatePlaneTangentsBitangents(std::vector<cyPoint3f> i_PlaneVertexPositions, std::vector<cyPoint3f> i_PlaneUVs, unsigned int i_VertexArrayID, 
